<template>
	<div class="st-container st-position">
		...
		<div class="st-scroll">
			...
			<section class="st-panel st-color st-panel-3-write">
				<div class="st-deco" data-icon="">POST</div>
				<v-container style="margin-top:20vh;" id="st-panel-3-write-content">
...
export default {
	...
	methods:{
		...
		submit : async function(content){
			...
			var res = controller.savePost(this.num, this.portitle, this.content);
			if(this.num == -1 && res){	// 글이 저장되었는데 새로 작성한 거면 푸쉬를 보내기
				var list = []
				list = await controller.findToken()
				var title = '포스트 새 글 등록'
...
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h1,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h2,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h3,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h4,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h5,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content h6,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content p,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content div,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content span,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content pre,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content ul,
#st-control-2:checked ~ .st-scroll #st-panel-3-write-content li
{
